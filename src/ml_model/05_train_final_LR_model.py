...
RESULTS_DIR = PROJECT_DIR / "results" / "final_LR_level1"
FIGURES_DIR = RESULTS_DIR / "figures"
MODEL_DIR = PROJECT_DIR / "models" / "LR_level1"

RESULTS_DIR.mkdir(parents=True, exist_ok=True)
FIGURES_DIR.mkdir(parents=True, exist_ok=True)
MODEL_DIR.mkdir(parents=True, exist_ok=True)

MODEL_PATH = MODEL_DIR / "LR_level1_no_weight_final_model_bundle.joblib"
METADATA_PATH = MODEL_DIR / "LR_level1_no_weight_final_model_metadata.json"
EXCEL_PATH = RESULTS_DIR / "LR_level1_no_weight_final_test_results.xlsx"
...
if not SPLIT_PATH.exists():
    raise FileNotFoundError(
        ...
        "Please run the LR comparison script first."
    )
...
metrics_row = {
    "model_name": "LR_level1_no_weight_final",
...
save_confusion_matrix_table(
    ...
    output_path=FIGURES_DIR / "LR_level1_final_test_confusion_table.png",
)

save_normalized_confusion_matrix_table(
    cm_df=cm_df,
    title="Final LR no weight - normalized test confusion matrix (%)",
    output_path=FIGURES_DIR / "LR_level1_final_test_confusion_table_normalized.png",
)

save_normalized_confusion_matrix_light_heatmap(
    cm_df=cm_df,
    title="Final LR no weight - normalized test confusion matrix (%)",
    output_path=FIGURES_DIR / "LR_level1_final_test_confusion_heatmap_light.png",
)
