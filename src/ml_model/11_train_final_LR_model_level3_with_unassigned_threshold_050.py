# 11_train_final_LR_model_level3_with_unassigned_feature.py

"""
Train the final selected Level 3 Logistic Regression model and save it with
an Unassigned confidence-threshold feature for GUI/inference integration.
...
This script saves:
1. Final trained model bundle for GUI/inference integration, saved in results/final_LR_unassigned_thresholds_level3
...
RESULTS_DIR = PROJECT_DIR / "models" / "final_LR_unassigned_thresholds_level3"
...
MODEL_PATH = MODEL_DIR / "LR_level3_no_weight_final_model_bundle_with_unassigned_threshold_050.joblib"
METADATA_PATH = MODEL_DIR / "LR_level3_no_weight_final_model_metadata_with_unassigned_threshold_050.json"
EXCEL_PATH = RESULTS_DIR / "LR_level3_no_weight_final_test_results_with_unassigned_threshold_050.xlsx"
...
metrics_row = {
    "model_name": "LR_level3_no_weight_final_with_unassigned",
...
experiment_info = pd.DataFrame({
    ...
    "value": [
        "LR_level3_no_weight_final_with_unassigned",
...
save_confusion_matrix_table(
    cm_df=cm_df,
    title="Final LR Level 3 with Unassigned - test confusion matrix",
    output_path=FIGURES_DIR / "LR_level3_final_test_confusion_table_with_unassigned.png",
)

save_normalized_confusion_matrix_table(
    cm_df=cm_df,
    title="Final LR Level 3 with Unassigned - normalized test confusion matrix (%)",
    output_path=FIGURES_DIR / "LR_level3_final_test_confusion_table_normalized_with_unassigned.png",
)

save_normalized_confusion_matrix_light_heatmap(
    cm_df=cm_df,
    title="Final LR Level 3 with Unassigned - normalized test confusion matrix (%)",
    output_path=FIGURES_DIR / "LR_level3_final_test_confusion_heatmap_light_with_unassigned.png",
)
